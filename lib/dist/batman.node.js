...
(function() {
  var BATMAN_ID_COUNTER, BatmanObject, ObjectFunctions, getAccessorObject, promiseWrapper, wrapSingleAccessor,
    __slice = [].slice,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Batman.InternalObject = (function(_super) {
    __extends(InternalObject, _super);

    Batman.extend(InternalObject.prototype, ObjectFunctions, Batman.EventEmitter, Batman.Observable);

    function InternalObject() {
      this._batman = this.object = this;
    }

    InternalObject.prototype.event = function(key, createEvent) {
      var storageKey, _ref;
      ...
      storageKey = "e-" + key;
      if (createEvent) {
        if ((_ref = this[storageKey]) == null) {
          this[storageKey] = new Batman.Event(this, key);
        }
      }
      return this[storageKey];
    };

    InternalObject.prototype.property = function(key) {
      var storageKey, _ref;

      storageKey = "p-" + key;
      if ((_ref = this[storageKey]) == null) {
        this[storageKey] = new Batman.Keypath(this, key);
      }
      return this[storageKey];
    };

    InternalObject.prototype.check = function() {
      return true;
    };

    InternalObject.prototype._batmanID = function() {
      var _base, _ref;

      this._batman.check(this);
      if ((_ref = (_base = this._batman).id) == null) {
        _base.id = BATMAN_ID_COUNTER++;
      }
      return this._batman.id;
    };

    InternalObject.prototype.hashKey = function() {
      var _base;
    ...
    InternalObject.accessor = function() {
      var _ref;

      return (_ref = this.prototype)._defineAccessor.apply(_ref, arguments);
    };

    InternalObject.prototype.accessor = InternalObject._defineAccessor;

    InternalObject.wrapAccessor = function() {
      var _ref;

      return (_ref = this.prototype)._defineWrapAccessor.apply(_ref, arguments);
    };

    InternalObject.prototype.wrapAccessor = InternalObject._defineWrapAccessor;

    InternalObject.observeAll = function() {
  ...
  BatmanObject = (function(_super) {
    ...
    Batman.extend(BatmanObject.prototype, ObjectFunctions, Batman.EventEmitter, Batman.Observable);

    Batman.extend(BatmanObject, ObjectFunctions, Batman.EventEmitter, Batman.Observable);
...
(function() {
  ...
  Batman.DOM.AbstractBinding = (function(_super) {
          ...
          result = this.filterFunctions.reduce(function(value, fn, i) {
            ...
            args = self.filterArguments[i].map(function(argument) {
              if (argument._keypath) {
                return renderContext.get(argument._keypath);
              } else {
                return argument;
              }
            });
    ...
    function AbstractBinding(definition) {
      this._fireDataChange = __bind(this._fireDataChange, this);      AbstractBinding.__super__.constructor.call(this);
