    ...
    RestStorage2.prototype.fetchAll = function(options, callback) {
      ...
      return new Batman.Request({
        ...
        success: function(json) {
          Batman.currentApp.dataStore.populate(json, _this.model);
...
(function() {
  ...
  Batman.Query = (function(_super) {
    ...
    Query.prototype.find = function() {
      return Batman.currentApp.dataStore.query(this.options);
    };
    ...
    Query.prototype.fetch = function(callback) {
      ...
      adapter = this.model.storageAdapter();
  ...
  Batman.DataStore = (function() {
    ...
    DataStore.prototype.query = function(options) {
      var model;
      if (options.limit === 1) {
        return this.querySingle(options);
      }
      if (model = options.model) {
        return this.modelStorage(model).forEach(function(id, record) {
          return model.fromRecord(record);
        });
      }
    };
    ...
    DataStore.prototype.populate = function(json, modelToForce) {
      var addedRecords, modelStorage,
        _this = this;
      modelStorage = this.modelStorage(modelToForce);
      addedRecords = [];
      modelStorage._preventMutationEvents(function() {
        var record, result, _i, _len;
        for (_i = 0, _len = json.length; _i < _len; _i++) {
          result = json[_i];
          record = _this.record(modelToForce, result.id, addedRecords);
      ...
      return modelStorage.fire('change', modelStorage, modelStorage);
    };
...
(function() {
  ...
  Batman.Model = (function(_super) {
    ...
    Model.find = function(id, callback) {
      return Batman.DataStore.forModel(this).record(id);
    };
    ...
    Model._mapIdentity = function(record) {
      ...
      if ((id = record.get('id')) != null) {
        record = Batman.DataStore.forModel(this.constructor).record(id);
      }
      return record;
      if ((id = record.get('id')) != null) {
