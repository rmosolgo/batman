    ...
    RestStorage2.prototype.fetchAll = function(options, callback) {
      ...
      return new Batman.Request({
        ...
        success: function(json) {
          Batman.DataStore.forModel(_this.model).populate(json);
...
(function() {
  ...
  Batman.Query = (function(_super) {
    ...
    Query.prototype.find = function() {
      return Batman.DataStore.forModel(this.model).query(this.options);
    };
  ...
  Batman.DataStore = (function(_super) {
    __extends(DataStore, _super);

    DataStore.forModel = function(modelClass) {
      var _base, _name;
      this.stores || (this.stores = {});
      return (_base = this.stores)[_name = modelClass.storageKey] || (_base[_name] = new Batman.DataStore(modelClass));
    };

    function DataStore(modelClass) {
    ...
    DataStore.prototype.query = function(options) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        id = _ref[_i];
        _results.push(this.modelClass.fromRecord(this.get(id)));
      }
      return _results;
    };
    ...
    DataStore.prototype.record = function(id) {
      var record,
        _this = this;
      record = this.getOrSet(id, function() {
        return new Batman.DataStoreRecord(_this, id);
      });
      return record;
    };

    DataStore.prototype.populate = function(json) {
      var record, result, _i, _len, _results;
      _results = [];
      for (_i = 0, _len = json.length; _i < _len; _i++) {
        result = json[_i];
        record = this.record(result.id);
  ...
  Batman.DataStoreRecord = (function(_super) {
    __extends(DataStoreRecord, _super);

    function DataStoreRecord(dataStore, id) {
      this.dataStore = dataStore;
      this.id = id;
      DataStoreRecord.__super__.constructor.call(this);
      this.dirtyKeys = [];
    }
    ...
    DataStoreRecord.prototype.set = function(key, value) {
      ...
      return DataStoreRecord.__super__.set.apply(this, arguments);
    };
...
(function() {
  ...
  Batman.Model = (function(_super) {
    ...
    Model.fromRecord = function(record) {
      ...
      record.forEach(function(key, value) {
